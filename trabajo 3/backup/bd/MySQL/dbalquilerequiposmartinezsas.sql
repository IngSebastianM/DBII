CREATE DATABASE  IF NOT EXISTS `alquiler_equipos_martinez_SAS` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `alquiler_equipos_martinez_SAS`;
-- MySQL dump 10.13  Distrib 8.0.43, for Win64 (x86_64)
--
-- Host: 172.19.49.6    Database: alquiler_equipos_martinez_SAS
-- ------------------------------------------------------
...
CREATE TABLE `equipments` (
  ...
  `status` char(20) NOT NULL,
  `daily_value` decimal(10,0) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `category_id_idx` (`category_id`),
  KEY `provider_id _idx` (`provider_id`),
...
--
-- Dumping events for database 'alquiler_equipos_martinez_SAS'
--

--
-- Dumping routines for database 'alquiler_equipos_martinez_SAS'
--
...
-- Dump completed on 2025-09-03 22:47:13
